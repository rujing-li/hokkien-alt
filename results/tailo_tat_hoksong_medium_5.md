...
```
    ...
    {'hok_audio': './data/hok_song/3-1.wav', 'hok_text_tailo_number_tone': 'Tinn1-bih8 ki3-ti5 i2-king1 pian3 khoo2-bi7 Thian1-tio5ng-te7-kiu2 tshiann2 li2 siu1 tng2--khi3 Siong1-sim1 long2 si7 ui7-tioh8 i1 Lih8--si5 kau3 am3-mi5', 'source': 'hok_song'}
...
```
    ...
    /tmp/ipykernel_8416/1919396851.py:1: FutureWarning: `tokenizer` is deprecated and will be removed in version 5.0.0 for `Seq2SeqTrainer.__init__`. Use `processing_class` instead.
      trainer = Seq2SeqTrainer(
...
```
 ...
 <tr style="text-align: left;">
  ...
  <tbody>
    ...
    TrainOutput(global_step=230, training_loss=0.48333872783443205, metrics={'train_runtime': 733.2255, 'train_samples_per_second': 5.019, 'train_steps_per_second': 0.314, 'total_flos': 3.7558260596736e+18, 'train_loss': 0.48333872783443205, 'epoch': 5.0})
...
```
    ...
    ./model/tailo-whisper-medium-hokkien-finetuned-5
...
<div>
  ...
  [86/86 11:06]
    ...
    ---
    Original Prediction: un1-too7 li7-tsap8-sann1 too7 tsi3 li7-tsap8-tshit4 too7,loh8-hoo7 ki1-lut8 li7-tsap8 pha1, lai5-pin1 goo7-pah4 goo7-tsap8-kau3 ho7 tshiann2-lai5 tsap8-sann1 ho7 kui7-tai5 pan7-li2
    ...
    Tokenized Prediction: un1 - t oo7 l i7 - ts ap8 - s ann1 t oo7 tsi i3 l i7 - ts ap8 - tshi it4 t oo7 , l oh8 - h oo7 k i1 - l ut8 l i7 - ts ap8 ph a1 ,  l ai5 - p in1 g oo7 - p ah4 g oo7 - ts ap8 - k au3 h o7 tshi iann2 - l ai5 ts ap8 - s ann1 h o7 k ui7 - t ai5 p an7 - l i2
    ...
    Prediction without Tones: un - t oo l i - ts ap - s ann t oo tsi i l i - ts ap - tshi it t oo , l oh - h oo k i - l ut l i - ts ap ph a ,  l ai - p in g oo - p ah g oo - ts ap - k au h o tshi iann - l ai ts ap - s ann h o k ui - t ai p an - l i
    ...
    ---
    Original Prediction: i1-ti7 i1 kiu2 su3 in2-ni5 tshut4-si3
    Original Ground Truth: i1-ti7 it4 kiu2 su3 it4 ni5 tshut4-si3
    Tokenized Prediction: i1 - t i7 i1 k iu2 s u3 in2 - n i5 tsh ut4 - si i3
    ...
    ---
    {'eval_loss': 0.7617414593696594, 'eval_wer': 62.36323851203501, 'eval_ser': 24.17207237965176, 'eval_ser_no_tones': 17.110869227180842, 'eval_runtime': 717.3415, 'eval_samples_per_second': 0.958, 'eval_steps_per_second': 0.12, 'epoch': 5.0}
...
```
    ...
    Transcription: {'text': 'it4-gi2 le5 tiam3, tsiu2 tsit8-pue1 tsit8-pue1 tsit8-pue1 le7 tah8, tshiann2 li2 ai3 teh4 liong7-gua7, gua7 tsiu2-ling5 bo5 hoo2, mai3 ka7 gua2 tshong3-khang1, si7 kan1 tsit8-kang1 tsit8-kang1 tsit8-kang1 le7 tsau2-hu7, kuann2 tsit8-tit8-tit8-tit8-tit8-tit8 le7 lau5.', 'chunks': [{'timestamp': (0.0, 21.0), 'text': 'it4-gi2 le5 tiam3, tsiu2 tsit8-pue1 tsit8-pue1 tsit8-pue1 le7 tah8, tshiann2 li2 ai3 teh4 liong7-gua7, gua7 tsiu2-ling5 bo5 hoo2, mai3 ka7 gua2 tshong3-khang1, si7 kan1 tsit8-kang1 tsit8-kang1 tsit8-kang1 le7 tsau2-hu7, kuann2 tsit8-tit8-tit8-tit8-tit8-tit8 le7 lau5.'}]}
