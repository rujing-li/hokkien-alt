...
```
    ...
    /tmp/ipykernel_9517/1919396851.py:1: FutureWarning: `tokenizer` is deprecated and will be removed in version 5.0.0 for `Seq2SeqTrainer.__init__`. Use `processing_class` instead.
      trainer = Seq2SeqTrainer(
...
```
 ...
 <tr style="text-align: left;">
  ...
  <tbody>
    ...
    TrainOutput(global_step=460, training_loss=0.2449356871049689, metrics={'train_runtime': 1461.466, 'train_samples_per_second': 5.036, 'train_steps_per_second': 0.315, 'total_flos': 7.5116521193472e+18, 'train_loss': 0.2449356871049689, 'epoch': 10.0})
...
```
    ...
    ./model/tailo-whisper-medium-hokkien-finetuned-10
...
<div>
  ...
  [86/86 07:27]
    ...
    ---
    Original Prediction: un1-too7 ji7-tsap8-sann1 too7 tsi3 ji7-tsap8 tshit4 too7,loh8-hoo7 ki1-lut8 ji7-tsap8 pha1, lai5-pin1 goo7-pah4 goo7-tsap8 kau3 ho7 tshiann2-lai5 tsap8-sann1 ho7 kui7-tai5 pan7-li2
    ...
    Tokenized Prediction: un1 - t oo7 ji i7 - ts ap8 - s ann1 t oo7 tsi i3 ji i7 - ts ap8 tshi it4 t oo7 , l oh8 - h oo7 k i1 - l ut8 ji i7 - ts ap8 ph a1 ,  l ai5 - p in1 g oo7 - p ah4 g oo7 - ts ap8 k au3 h o7 tshi iann2 - l ai5 ts ap8 - s ann1 h o7 k ui7 - t ai5 p an7 - l i2
    ...
    Prediction without Tones: un - t oo ji i - ts ap - s ann t oo tsi i ji i - ts ap tshi it t oo , l oh - h oo k i - l ut ji i - ts ap ph a ,  l ai - p in g oo - p ah g oo - ts ap k au h o tshi iann - l ai ts ap - s ann h o k ui - t ai p an - l i
    ...
    ---
    Original Prediction: i1-ti7 it4 kiu2 su3 in2-ni5 tshut4-si3
    Original Ground Truth: i1-ti7 it4 kiu2 su3 it4 ni5 tshut4-si3
    Tokenized Prediction: i1 - t i7 it4 k iu2 s u3 in2 - n i5 tsh ut4 - si i3
    ...
    ---
    {'eval_loss': 0.8887045979499817, 'eval_wer': 60.896623256886016, 'eval_ser': 23.16690973407391, 'eval_ser_no_tones': 16.70138349137261, 'eval_runtime': 495.552, 'eval_samples_per_second': 1.386, 'eval_steps_per_second': 0.174, 'epoch': 10.0}
...
```
    ...
    Transcription: {'text': 'it4-gi2 le5 tiam3, tsiu2 tsit8-pue3 tsit8-pue3 tsit8-pue3 le5 tah8, tshiann2 li2 ai3 the5-liong1-gua7, gua7 tsiu2-liong1 bo5 ho2, mai3 ka7 gua2 tshong3-khang1, si7-kan1 tsit8-kang1 tsit8-kang1 tsit8-kang1 le7 tsau5, kuann2 tsit8-tit8-tit8-tit8-tit8-tit8 e5 lau5', 'chunks': [{'timestamp': (0.0, 21.0), 'text': 'it4-gi2 le5 tiam3, tsiu2 tsit8-pue3 tsit8-pue3 tsit8-pue3 le5 tah8, tshiann2 li2 ai3 the5-liong1-gua7, gua7 tsiu2-liong1 bo5 ho2, mai3 ka7 gua2 tshong3-khang1, si7-kan1 tsit8-kang1 tsit8-kang1 tsit8-kang1 le7 tsau5, kuann2 tsit8-tit8-tit8-tit8-tit8-tit8 e5 lau5'}]}
