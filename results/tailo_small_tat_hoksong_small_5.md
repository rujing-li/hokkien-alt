...
```
    ...
    {'hok_audio': './data/hok_song/1-4.wav', 'hok_text_tailo_number_tone': 'm7-thang1 tong3-tsue3 gun2 hong1-too7 khin1-phu5, tsuan5 bang7 li2 jiah8-tsing5 e5 lang5-kheh1-hiann1 Kua1-siann1 tsiann5 be5-lang5, guan2 e5 sim1-tsing5 si7 am3-tam7, jit8-jit8-ia7-ia7 leh1 tsue3-bang7, tng2-lai5-khi3 gua2, gua2 un1-luan2 e5 koo3-hiong1', 'source': 'hok_song'}
...
```
    ...
    /tmp/ipykernel_7109/1919396851.py:1: FutureWarning: `tokenizer` is deprecated and will be removed in version 5.0.0 for `Seq2SeqTrainer.__init__`. Use `processing_class` instead.
      trainer = Seq2SeqTrainer(
...
```
 ...
 <tr style="text-align: left;">
  ...
  <tbody>
    ...
    TrainOutput(global_step=230, training_loss=0.8062574150769607, metrics={'train_runtime': 341.6924, 'train_samples_per_second': 10.77, 'train_steps_per_second': 0.673, 'total_flos': 1.0619942731776e+18, 'train_loss': 0.8062574150769607, 'epoch': 5.0})




```python
save_path = pwd + '/model/' + target +'-whisper-'+ size +'-hokkien-finetuned-' + n_epoch
print(save_path)
model.save_pretrained(save_path)
processor.save_pretrained(save_path)
```

    ./model/tailo-whisper-small-hokkien-finetuned
...
<div>
  ...
  [86/86 05:06]
    ...
    ---
    Original Prediction: un1-too7 li7-tsap8-sann1 too7 tsi3 ti7-tsap8-tshit4 too7,loh8-hoo7 ki1-lut8 li7-tsap8 pha1, lai5-pin1 goo7-pah4 goo7-tsap8 kau3 ho7 tshiann2-lai5 tsap8 sann1 ho7 kui7-tai5 pang1-li2
    ...
    Tokenized Prediction: un1 - t oo7 l i7 - ts ap8 - s ann1 t oo7 tsi i3 t i7 - ts ap8 - tshi it4 t oo7 , l oh8 - h oo7 k i1 - l ut8 l i7 - ts ap8 ph a1 ,  l ai5 - p in1 g oo7 - p ah4 g oo7 - ts ap8 k au3 h o7 tshi iann2 - l ai5 ts ap8 s ann1 h o7 k ui7 - t ai5 p ang1 - l i2
    ...
    Prediction without Tones: un - t oo l i - ts ap - s ann t oo tsi i t i - ts ap - tshi it t oo , l oh - h oo k i - l ut l i - ts ap ph a ,  l ai - p in g oo - p ah g oo - ts ap k au h o tshi iann - l ai ts ap s ann h o k ui - t ai p ang - l i
    ...
    ---
    {'eval_loss': 0.7281205058097839, 'eval_wer': 73.57817177066543, 'eval_ser': 30.348891300976895, 'eval_ser_no_tones': 21.620781803492637, 'eval_runtime': 354.7886, 'eval_samples_per_second': 1.936, 'eval_steps_per_second': 0.242, 'epoch': 5.0}
...
```
    ...
    Transcription: {'text': 'i1-ki1 leh4 tiam2 tsiu2 tsit8-pue3 tsit8-pue3 tsit8-pue3 e5 ta1tshiau2 li7 ai3-ti7-liong7-gua2gua2 tsiu2-liong7 bo5-hoo7 mai3-ka1 gua2 tshong3-khang2si7-kang1 tsit8-kang1 tsit8-kang1 e5 tsa2-hu7kua2 tsit8-tsit8-tsit8-tsit8 e5 lau5', 'chunks': [{'timestamp': (0.0, 6.32), 'text': 'i1-ki1 leh4 tiam2 tsiu2 tsit8-pue3 tsit8-pue3 tsit8-pue3 e5 ta1'}, {'timestamp': (6.32, 10.52), 'text': 'tshiau2 li7 ai3-ti7-liong7-gua2'}, {'timestamp': (10.52, 14.28), 'text': 'gua2 tsiu2-liong7 bo5-hoo7 mai3-ka1 gua2 tshong3-khang2'}, {'timestamp': (14.28, 18.32), 'text': 'si7-kang1 tsit8-kang1 tsit8-kang1 e5 tsa2-hu7'}, {'timestamp': (18.32, 21.32), 'text': 'kua2 tsit8-tsit8-tsit8-tsit8 e5 lau5'}]}
