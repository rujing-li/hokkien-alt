...
```
    ...
    {'hok_audio': './data/hok_song/2-3.wav', 'hok_text_tailo_number_tone': 'u7-si5-tsun7 jiat8-hong1-hong1, u7-si5-tsun7 tsiok1 sit1-bong7 jiat8-luan5 tsai7 hong1-tiong1, tshun1 lai5 tshiu1 khi3, u7-tsing5 tioh8-ai3 po2-tiong7 i1 tshin1-tshiunn7 tsit8-tsun7 hong1, khin1-khin1 tsiong1 gun2 sian3-tong7 lak8-gueh8 e5 bang7-tiong1, iu1-guan5 siong1-sin3, u7-tsit8-jit8 tsai3 siong1-hong5', 'source': 'hok_song'}
...
```
    ...
    /tmp/ipykernel_6386/1919396851.py:1: FutureWarning: `tokenizer` is deprecated and will be removed in version 5.0.0 for `Seq2SeqTrainer.__init__`. Use `processing_class` instead.
      trainer = Seq2SeqTrainer(
...
```
 ...
 <tr style="text-align: left;">
  ...
  <tbody>
    ...
    Original Prediction: sua3-loh8-lai5 khuann3 sin1-tik8-tshi7 bin5-a2-tsai3 it4-ho7 e5 thinn1-khi3
    Original Ground Truth: sua3-loh8-lai5 khuann3 sin1-tik4-tshi7 bin5-a2-tsai3 it4 ho7 e5 thinn1-khi3
    Tokenized Prediction: s ua3 - l oh8 - l ai5 kh uann3 si in1 - t ik8 - tshi i7 b in5 - a2 - ts ai3 it4 - h o7 e5 th inn1 - kh i3
    ...
    ---
    Original Prediction: un1-too7 li7 tsap8-sann1 too7 tsi3 ti7 tsiok8-tshit4 too7,loh8-hoo7 ki1-lut8 li7 tsap8 pha1, lai5-pin1 goo7-pah4 goo7 tsap8 kau3 ho7 tshiann2-lai5 tsap8 sann1 ho7 kui7-tai5 pang1-li2
    ...
    Tokenized Prediction: un1 - t oo7 l i7 ts ap8 - s ann1 t oo7 tsi i3 t i7 tsi iok8 - tshi it4 t oo7 , l oh8 - h oo7 k i1 - l ut8 l i7 ts ap8 ph a1 ,  l ai5 - p in1 g oo7 - p ah4 g oo7 ts ap8 k au3 h o7 tshi iann2 - l ai5 ts ap8 s ann1 h o7 k ui7 - t ai5 p ang1 - l i2
    ...
    Prediction without Tones: un - t oo l i ts ap - s ann t oo tsi i t i tsi iok - tshi it t oo , l oh - h oo k i - l ut l i ts ap ph a ,  l ai - p in g oo - p ah g oo ts ap k au h o tshi iann - l ai ts ap s ann h o k ui - t ai p ang - l i
    ...
    ---
    Original Prediction: i1-ti7 i2 kiu2 su3 in3 ni5 tshut4-si3
    Original Ground Truth: i1-ti7 it4 kiu2 su3 it4 ni5 tshut4-si3
    Tokenized Prediction: i1 - t i7 i2 k iu2 s u3 in3 n i5 tsh ut4 - si i3
    ...
    Original Prediction: sua3-loh8-lai5 khuann3 sin1-tik8-tshi3 pinn1-a2-tsai3 it4-ho7 e5 thinn1-khi3
    Original Ground Truth: sua3-loh8-lai5 khuann3 sin1-tik4-tshi7 bin5-a2-tsai3 it4 ho7 e5 thinn1-khi3
    Tokenized Prediction: s ua3 - l oh8 - l ai5 kh uann3 si in1 - t ik8 - tshi i3 p inn1 - a2 - ts ai3 it4 - h o7 e5 th inn1 - kh i3
    Tokenized Ground Truth: s ua3 - l oh8 - l ai5 kh uann3 si in1 - t ik4 - tshi i7 b in5 - a2 - ts ai3 it4 h o7 e5 th inn1 - kh i3
    Prediction without Tones: s ua - l oh - l ai kh uann si in - t ik - tshi i p inn - a - ts ai it - h o e th inn - kh i
    Ground Truth without Tones: s ua - l oh - l ai kh uann si in - t ik - tshi i b in - a - ts ai it h o e th inn - kh i
    ---
    Original Prediction: un1-too7 li7 tsap8-sann1 too7 tsi3 ti7 tsiok8-tshit4 too7,loh8-hoo7 ki1-lut8 li7 tsap8 pha1, lai5-pin1 goo7-pah4 goo7 tsap8 kau3 ho7 tshiann2-lai5 tsap8 sann1 ho7 kui7-tai5 pang1-li2
    Original Ground Truth: un1-too7 li7-tsap8-sann1 too7 tsi3 ji7-tsap8 tshit4 too7,loh8-hoo7 ki1-lut8 li7 tsap8% lai5-pin1 goo7-pah4 goo7-tsap8 kau2 ho7 tshiann2-lai5 tsap8-sann1 ho7 kui7-tai5 pan7-li2
    ...
    TrainOutput(global_step=2300, training_loss=0.07654089129641248, metrics={'train_runtime': 4363.775, 'train_samples_per_second': 8.433, 'train_steps_per_second': 0.527, 'total_flos': 1.0619942731776e+19, 'train_loss': 0.07654089129641248, 'epoch': 50.0})
...
```
    ...
    ./model/tailo-whisper-small-hokkien-finetuned-50
...
<div>
  ...
  [86/86 03:02]
    ...
    Ground Truth without Tones: i - t i it k iu s u it n i tsh ut - si i
    ---
    {'eval_loss': 1.1454144716262817, 'eval_wer': 69.27322907083716, 'eval_ser': 27.522537872920477, 'eval_ser_no_tones': 20.070149300058976, 'eval_runtime': 231.5604, 'eval_samples_per_second': 2.967, 'eval_steps_per_second': 0.371, 'epoch': 50.0}
...
```
    ...
    Transcription: {'text': 'i1-ki1 leh1 tiam2, tsio2 tsit8-pue3-tsit8-pue3 tsit8-pue3 e5 ta1,tshiau3 li2 ai3 thih8-liong1-gua2, gua2 tsio2-liong1 bo5 hu1-ma2 i1 ka7 gua2 tshong3-khang1, si5-kang1 tsit8-kang1 tsit8-kang1 e5 tsau3, kuann2 tsit8-tit8-tit8 e5 lau5.', 'chunks': [{'timestamp': (0.0, 6.32), 'text': 'i1-ki1 leh1 tiam2, tsio2 tsit8-pue3-tsit8-pue3 tsit8-pue3 e5 ta1,'}, {'timestamp': (6.32, 14.36), 'text': 'tshiau3 li2 ai3 thih8-liong1-gua2, gua2 tsio2-liong1 bo5 hu1-ma2 i1 ka7 gua2 tshong3-khang1,'}, {'timestamp': (14.36, 18.32), 'text': ' si5-kang1 tsit8-kang1 tsit8-kang1 e5 tsau3,'}, {'timestamp': (18.32, 21.28), 'text': ' kuann2 tsit8-tit8-tit8 e5 lau5.'}]}
